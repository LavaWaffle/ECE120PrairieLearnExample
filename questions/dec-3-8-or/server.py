...
ANSWERS = {
    'I_2 * I_1 + I_0': { 
        'eval': Or(And(I_2, I_1), I_0),
        'repr': 'H + G + F + D + B'
    },
    'I_2 + I_1 * I_0': { 
        'eval': Or(I_2, And(I_1, I_0)),
        'repr': 'H + G + F + E + D'
    },
    "I_2' * I_1 + I_0": {
        'eval': Or(And(Not(I_2), I_1), I_0),
        'repr': 'B + D + F + H + C',
    },
    "(I_2 + I_1)' + I_0": { 
        'eval': Or(Not(Or(I_2, I_1)), I_0),
        'repr': 'A + B + D + F + H'
    },
    "I_2' * I_1' + I_2 * I_0": { 
        'eval': Or(And(Not(I_2), Not(I_1)), And(I_2, I_0)),
        'repr': 'A + B + F + H'
    },
    "I_2 * (I_1' + I_0) + I_1 * I_0'": {
        'eval': Or(And(I_2, Or(Not(I_1), I_0)), And(I_1, Not(I_0))),
        'repr': 'C + E + F + G + H'
    },
}
